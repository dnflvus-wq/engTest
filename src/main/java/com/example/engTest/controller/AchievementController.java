...
public class AchievementController {
    ...
    @GetMapping("/achievements/unread")
    ...
    @PostMapping("/achievements/mark-read")
    ...
    @GetMapping("/achievements/summary/{userId}")
    ...
    @GetMapping("/badges/equipped/all")
    ...
    @GetMapping("/badges/equipped/{userId}")
