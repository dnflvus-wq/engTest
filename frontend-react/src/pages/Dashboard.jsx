    ...
    return (
        <section className="active-section">
            <div className="dashboard-grid">
                ...
                <div className="clay-card widget" onClick={() => navigate('/logs')}>
                    <div className="widget-icon color-gray">
                ...
                {user?.id === 1 && (
                    <div className="clay-card widget" onClick={() => navigate('/admin')}>
                        <div className="widget-icon color-red">
